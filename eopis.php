...
include "details.php";
											echo	"<div class='otresci'>Description: <br />".$row['description']."</div><br />";
		...
		if(isset($_POST['editSubmit']))
				{
					...
					$sql = "UPDATE uzytkownik SET description='$pedit' WHERE id='$id'";
...
echo	"<form method='POST' action='".setEdytor($polaczenie)."'>
		<div class='oedit'>
			...
			<textarea name='pedit' rows='5' placeholder=' .Here'></textarea>
		</div><br />
