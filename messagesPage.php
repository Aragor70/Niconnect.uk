...
<div class="navispace">
	<div class="naviname">Yours Notifications</div>
</div>						
			<div class='notificationBox'>
				<div class='zapytania' id='zapytania'>
					

					<input type="hidden" id="uname" value='<?php echo $_SESSION['user'];?>'>
								...
								http.onreadystatechange=function(){
									if(this.readyState==4 && this.status==200)
									{
										var zapytania=document.getElementById("zapytania").innerHTML=this.responseText;
									}
								};
								http.open("GET", "zapytanie.php?uid="+uid, true);
								http.send();
