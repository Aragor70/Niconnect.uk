...
<div class="navispace">
	<div class="naviname" style='margin-left: 10px;'>Niconnection</div>
			...
			<p>Send the message</p><br>
			
		<button class='contact-me-btn'>The Message</button>
			
			<div class="modal contact-me-modal">
			<br>
				<button class='close-btn'>back</button>
			<br>
			<div class='row'>
				<p> Send the message to me</p>
			</div>		
					<form class='contact-form'>
						<div class='row'>
						 <label for='msg-text'>Wiadomość</label><br><input textarea id='msg-text'></textarea>
						</div>
						<div class='row'>
